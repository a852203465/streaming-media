package cn.darkjrong.streamingmedia.sream;
 ...
 *
 * @author Rong.Jia
 * @date 2020/12/12 01:45
 */
public class CommandManagerTest extends StreamingMediaApplicationTests {
...
//		manager.start("tomcat8", "ffmpeg -i rtsp://184.72.239.149/vod/mp4://BigBuckBunny_175k.mov -vcodec copy -acodec copy -f flv -y rtmp://106.14.182.20:1935/rtmp/tomcat8",false);
        manager.start("tomcat9", "ffmpeg -i F:\\a.mp4 -vcodec copy -acodec copy -f flv -y rtmp://192.168.37.128/live/tomcat9", false);
     ...
     * @throws InterruptedException
     */
    public void testStreamCommandAssmbly() throws InterruptedException {
        manager.start("test1", CommandBuilderFactory.createBuilder()
     ...
     * @throws InterruptedException
     */
    public void testBrokenMuti() throws InterruptedException {
        manager.start("test1", CommandBuilderFactory.createBuilder()
                .add("ffmpeg").add("-i", "rtsp://184.72.239.149/vod/mp4://BigBuckBunny_175k.mov")
                .add("-rtsp_transport", "tcp")
                .add("-vcodec", "copy")
                ...
                .add("-f", "flv")
                .add("-y").add("rtmp://106.14.182.20:1935/rtmp/test1"));
        manager.start("test2", CommandBuilderFactory.createBuilder()
                .add("ffmpeg").add("-i", "rtsp://184.72.239.149/vod/mp4://BigBuckBunny_175k.mov")
                .add("-rtsp_transport", "tcp")
                .add("-vcodec", "copy")
                .add("-acodec", "copy")
        ...
        manager.start("test3", CommandBuilderFactory.createBuilder()
                .add("ffmpeg").add("-i", "rtsp://184.72.239.149/vod/mp4://BigBuckBunny_175k.mov")
                .add("-rtsp_transport", "tcp")
                .add("-vcodec", "copy")
                .add("-acodec", "copy")
        ...
        manager.start("test4", CommandBuilderFactory.createBuilder()
                .add("ffmpeg").add("-i", "rtsp://184.72.239.149/vod/mp4://BigBuckBunny_175k.mov")
                .add("-rtsp_transport", "tcp")
                .add("-vcodec", "copy")
                .add("-acodec", "copy")
        ...
        manager.start("test5", CommandBuilderFactory.createBuilder()
                .add("ffmpeg").add("-i", "rtsp://184.72.239.149/vod/mp4://BigBuckBunny_175k.mov")
//				.add("-rtsp_transport","tcp")
                .add("-vcodec", "copy")
                .add("-acodec", "copy")
